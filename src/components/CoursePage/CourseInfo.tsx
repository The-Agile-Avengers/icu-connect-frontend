...
export default function CourseInfo() {
  ...
  return (
    ...
    >
      <Typography component="legend" ><b>Course Name: </b>{courseName}</Typography>
      <Typography component="legend" ><b>Number: </b> {courseNumber}</Typography>
      <Typography component="legend" ><b>ECTS: </b> {ects}</Typography>
      <Typography component="legend" ><b>Teacher: </b> {teacher}</Typography>
      <Typography component="legend" ><b>Description:</b> {description}</Typography>
